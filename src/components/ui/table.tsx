...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left text-[16px] align-middle font-bold text-zinc-500 [&:has([role=checkbox])]:pr-0 dark:text-zinc-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-4 align-middle font-semibold [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
