  ...
  const setHasAlgae = (hasAlgae: boolean) => {
    if (hasAlgae) {
      context.setGamePieceState([
        ...
        { type: GAME_PIECES_2025.ALGAE, count: 1 },
      ]);
    } else {
      context.setGamePieceState([
        context.gamePieceState[0],
          ...
          >
            ...
            >
              <ScoutActionButton
                ...
                gamePiece={GAME_PIECES_2025.CORAL}
                location={LOCATIONS_2025.CORAL_STATION.LEFT}
                label="Coral Pickup"
              ...
              <ScoutActionButton
                ...
                actionName={ACTION_NAMES.INTAKE}
                gamePiece={GAME_PIECES_2025.CORAL}
                location={LOCATIONS_2025.GROUND}
              ...
              <ScoutActionButton
                ...
                actionName={ACTION_NAMES.INTAKE}
                gamePiece={GAME_PIECES_2025.ALGAE}
                location={LOCATIONS_2025.GROUND}
              ...
              <ScoutActionButton
                ...
                actionName={ACTION_NAMES.INTAKE}
                gamePiece={GAME_PIECES_2025.CORAL}
                location={LOCATIONS_2025.CORAL_STATION.RIGHT}
                label="Coral Pickup"
                isAuto={context.matchState === MATCH_STATES.AUTO}
                disabled={checkIsDisabled(isDisabled) || hasCoral == true}
                onClick={() => {
              ...
              <div className="flex flex-col gap-16 mt-28 items-center">
                <div className="flex flex-col gap-3">
                  <ScoutActionButton
                    ...
                    gamePiece={GAME_PIECES_2025.ALGAE}
                    location={LOCATIONS_2025.REEF.BASE}
            ...
            <div className="flex flex-col items-center justify-center h-full gap-3">
              <ScoutActionButton
                ...
                gamePiece={GAME_PIECES_2025.CORAL}
                location={LOCATIONS_2025.REEF.L4}
              ...
              <ScoutActionButton
                actionName={ACTION_NAMES.SCORE}
                gamePiece={GAME_PIECES_2025.CORAL}
                location={LOCATIONS_2025.REEF.L3}
                className="font-bold text-xl dark:bg-yellow-500 w-40 h-16 text-black"
                label="L3 Score"
                isAuto={context.matchState === MATCH_STATES.AUTO}
                onClick={() => {
              ...
              <ScoutActionButton
                actionName={ACTION_NAMES.SCORE}
                gamePiece={GAME_PIECES_2025.CORAL}
                location={LOCATIONS_2025.REEF.L2}
                className="font-bold text-xl dark:bg-yellow-500 w-40 h-16 text-black"
                label="L2 Score"
                isAuto={context.matchState === MATCH_STATES.AUTO}
                onClick={() => {
              ...
              <ScoutActionButton
                actionName={ACTION_NAMES.SCORE}
                gamePiece={GAME_PIECES_2025.CORAL}
                location={LOCATIONS_2025.REEF.L1}
                className="font-bold text-xl dark:bg-yellow-500 w-40 h-16 text-black"
                label="L1 Score"
                isAuto={context.matchState === MATCH_STATES.AUTO}
                onClick={() => {
              ...
              >
                ...
                >
                  ...
                  <ScoutActionButton
                    ...
                    actionName={ACTION_NAMES.SCORE}
                    gamePiece={GAME_PIECES_2025.ALGAE}
                    location={LOCATIONS_2025.PROCESSOR}
