...
import ScoutActionButton from "./scout-action-button";
  ...
  export const MatchScoutingLayout = ({ isDisabled }: { isDisabled: boolean }) => {
    ...
    const [isCoralMissSelectionOpen, setIsCoralMissSelectionOpen] =
      useState(false);
    const [isDislodgeSelectionOpen, setIsDislodgeSelectionOpen] =
      useState(false);
              ...
              <div className="flex flex-col items-center justify-between h-full w-full gap-3">
                ...
                <div className="flex flex-col items-center justify-between">
                  <Popover
                    ...
                    onOpenChange={
                      setIsCoralMissSelectionOpen ||
                      setIsCoralScoreSelectionOpen
                    }
                  >
                    <PopoverTrigger
                      asChild
                      disabled={checkIsDisabled(
                        isDisabled || hasCoral == false
                      )}
                    >
